...
exports.getIndexHTML = async (data) => {
    ...
    const localFepackerVersion = '0.0.58';
    // let versionRes = await request.get({
    //     url: 'http://npm.ifengcloud.ifeng.com/-/verdaccio/sidebar/@ifeng/fepacker',
    //     json: true,
    // });
    // 远程上的最新版本
    // let lastFepackerVersion = Object.keys(versionRes.versions)
    //     .reverse()
    //     .find((a) => !a.includes('test'));
    lastFepackerVersion = '0.0.58';
    try {
